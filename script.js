    ...
    .then(function(response) {
      ...
      if (json != null) {
        ...
        if (json.officialSite != null) {
          results += '<p><b>Official Site: </b><a href="' + json.officialSite + '">' + json.officialSite + '</p></a>';
        }
        if (json.rating.average != null) {
          results += '<p><b>Average Rating: </b>' + json.rating.average + '</p>';
        } else {
          results += '<p><b>Average Rating: </b><i>No Rating Available</i></p>';
        }
        results += '<p><b>Premiered: </b>' + json.premiered + '</p>';
        results += '<p><b>Status: </b>' + json.status + '</p>';
        if (json.network != null) {
          results += '<p><b> Network: </b>' + json.network.name + '</p>';
        }
        results += '</div>';
        results += '<div class="col-md-3">';
